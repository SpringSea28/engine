...
#ifndef FLUTTER_LIB_UI_BARCODE_BARCODE_PARAGRAPH_BUILDER_H_
#define FLUTTER_LIB_UI_BARCODE_BARCODE_PARAGRAPH_BUILDER_H_
...
class BarcodeParagraphBuilder : public RefCountedDartWrappable<BarcodeParagraphBuilder> {
  DEFINE_WRAPPERTYPEINFO();
  FML_FRIEND_MAKE_REF_COUNTED(BarcodeParagraphBuilder);
 ...
 public:
  ...
  ~BarcodeParagraphBuilder() override;
 ...
 private:
  explicit BarcodeParagraphBuilder(Dart_Handle encoded,
                            Dart_Handle strutData,
                            const std::string& fontFamily,
                            const std::vector<std::string>& strutFontFamilies,
                            double fontSize,
...
#endif  // FLUTTER_LIB_UI_BARCODE_BARCODE_PARAGRAPH_BUILDER_H_
